...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	String branch = "CompSci";
	String year = "First";
	String subject = "ALG";

	private String[] branchString = new String[] { "CompSci"};
	private String[] yearString = new String[] {"First","Second","Third"};
	private String[] subjectSEString = new String[] {"PY","JV"};
	private String[] subjectTEString = new String[] {"C","SE"};
	private String[] subjectBEString = new String[] {"AI","WD"};

	private String[] subjectFinal = new String[] {"PY","JV","C","SE","AI","WD"};
